...
export const experiences: Experience[] = [
  ...
  { id: 'discovery', emoji: '🤝', skill: 'Discovery', title: 'Mentorías, eventos y comunidad', subtitle: 'Mentorías, eventos, comunidad', eje: 'growth', image: backpackingLatamImg,
    badges: [],
